...
### 3. `Alternative input`
The subfolder Wnet_altinput stores an alternative version of Wnet (Wnetb.h5) using a different set of inputs that can be more easily found in some models/reanalysis. The python and fortran 90 versions of Wnet as well, the weights, and testing code are found in the the subfolder ./Wnet_altinput 
