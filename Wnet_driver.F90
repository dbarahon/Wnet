...
!!!!Example of Wnet usage in Fortran.     
  ...
  integer, parameter :: NF = 14  ! Number of samples
  real(dp) :: input(Ns, NF)
  real(dp) :: output(Ns)
  ...
  real(dp) :: mean(NF) = (/243.9, 0.6, 6.3, 0.013, 0.0002, 5.04, 21.8, 0.002, 9.75e-7, &
                           7.87e-6, 0.6, 5.04, 21.8, 0.002/)
  ...
  deallocate(seed)
  WRITE(*,"(14A)") ,  "   'T',    'AIRD',    'U',    'V',    'W',    'KM',    'RI',    'QV',    'QI',    'QL',    'AIRD_sfc',    'KM_sfc',    'RI_sfc',    'QV_sfc'"
